...
module.exports = {
    activate() {
        ...
        let disposables = [
            atom.commands.add('atom-text-editor', 'Python run: run-alt-f5', saveAndRun.bind(this, 'alt-f5')),
            atom.commands.add('atom-text-editor', 'Python run: run-ctrl-alt-f6', saveAndRun.bind(this, 'ctrl-alt-f6')),
        ];
    ...
    config: {
        ...
        f5Command: {
            title: 'Alt + F5 Command',
            description: '`{file}` = `{dir}/{name}{ext}`',
            type: 'string',
            default: 'python {file}'
        },
        f6Command: {
            title: 'Ctrl + Alt + F6 Command',
